...
asteroid_belt_19.txt | орбіта 250: 19 астероїдів, на кожному один орбітальний ресурс по 500 (єдність 501) | зірка
...
district_slots_10.txt / _20 / _30 | +10 / +20 / +30 до максимуму районів, розмір колонії не змінюється | колонія еку, геї або хабітата
districts_10.txt | міські райони до капу планети, розмір не змінюється | колонія
gaia_*_10.txt | Гея: спеціалізація до капу (енергія/шахти/ферми/motes/кристали/гази/бетаріан/сплави/товари/наука/єдність/торгівля/фортеця) | колонія Геї
...
Райони до капу, без зміни розміру
---------------------------------
Виділи колонію. planet_size не чіпається. Райони ставляться, поки є вільний слот капу. ignore_cap немає.
districts_10.txt — міські (district_city) до вільного капу планети.
gaia_*_10.txt — те саме на Геї, плюс зона спеціалізації.
Сільські ще й упираються у свій кап типу (родовища): генератори, шахти, ферми.
Міські спеціалізації (сплави, товари, наука, фізика, соціум, інженерія, єдність, торгівля, фортеця) ділять одні city-зони: наступний запуск замінює спеціалізацію всіх міських районів планети.
Якщо вільних слотів немає, нових районів не буде.
